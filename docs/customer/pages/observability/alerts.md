...
Storage and backend alerts requiring operator attention.
...
- Route: `/alerts`
- Nav: **OBSERVABILITY → Alerts** (sidebar, dock, or spotlight)

## What you can do

1. Open `/alerts` and wait for live data from the Atlas gateway (default **:5110**).
