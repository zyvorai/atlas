...
Audit log of storage control-plane actions (exportable).
...
- Route: `/audit`
- Nav: **OBSERVABILITY → Audit** (sidebar, dock, or spotlight)

## What you can do

1. Open `/audit` and wait for live data from the Atlas gateway (default **:5110**).
