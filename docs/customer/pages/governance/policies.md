...
Storage intent policies (production, database, development, shared, ai).
...
- Route: `/policies`
- Nav: **GOVERNANCE → Policies** (sidebar, dock, or spotlight)

## What you can do

1. Open `/policies` and wait for live data from the Atlas gateway (default **:5110**).
