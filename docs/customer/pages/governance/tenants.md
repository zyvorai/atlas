...
Multi-tenant isolation and quota boundaries.
...
- Route: `/tenants`
- Nav: **GOVERNANCE → Tenants** (sidebar, dock, or spotlight)

## What you can do

1. Open `/tenants` and wait for live data from the Atlas gateway (default **:5110**).
