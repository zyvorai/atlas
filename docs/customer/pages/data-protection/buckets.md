...
Object / RGW bucket inventory and lifecycle.
...
- Route: `/buckets`
- Nav: **DATA PROTECTION → Buckets** (sidebar, dock, or spotlight)

## What you can do

1. Open `/buckets` and wait for live data from the Atlas gateway (default **:5110**).
