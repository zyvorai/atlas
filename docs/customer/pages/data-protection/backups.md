...
Backup jobs and restore entry points for protected volumes.
...
- Route: `/backups`
- Nav: **DATA PROTECTION → Backups** (sidebar, dock, or spotlight)

## What you can do

1. Open `/backups` and wait for live data from the Atlas gateway (default **:5110**).
