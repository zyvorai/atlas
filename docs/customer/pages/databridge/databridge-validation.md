...
Pre/post migration validation results.
...
- Nav: **DATABRIDGE → Validation** (sidebar, dock, or spotlight)

## What you can do

1. Open `/databridge/validation` and wait for live data from the Atlas gateway (default **:5110**).
