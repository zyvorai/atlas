...
Ongoing replication links for DataBridge workloads.
...
- Nav: **DATABRIDGE → Replication** (sidebar, dock, or spotlight)

## What you can do

1. Open `/databridge/replication` and wait for live data from the Atlas gateway (default **:5110**).
