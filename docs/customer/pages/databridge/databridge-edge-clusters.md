...
Edge database clusters managed through DataBridge.
...
- Nav: **DATABRIDGE → Edge DB Clusters** (sidebar, dock, or spotlight)

## What you can do

1. Open `/databridge/edge-clusters` and wait for live data from the Atlas gateway (default **:5110**).
