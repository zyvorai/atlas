...
Single migration plan detail — stages, validation, and cutover.
...
- Nav: **DATABRIDGE → Plan Detail** (sidebar, dock, or spotlight)

## What you can do

1. Open `/databridge/plans/:id` and wait for live data from the Atlas gateway (default **:5110**).
