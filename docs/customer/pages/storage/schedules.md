...
Snapshot / backup schedule policies.
...
- Route: `/schedules`
- Nav: **STORAGE → Schedules** (sidebar, dock, or spotlight)

## What you can do

1. Open `/schedules` and wait for live data from the Atlas gateway (default **:5110**).
