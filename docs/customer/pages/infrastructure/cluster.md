...
Atlas gateway cluster / HA membership view.
...
- Route: `/cluster`
- Nav: **INFRASTRUCTURE → Cluster** (sidebar, dock, or spotlight)

## What you can do

1. Open `/cluster` and wait for live data from the Atlas gateway (default **:5110**).
