...
Disaster recovery plans and failover for Atlas-managed data.
...
- Route: `/dr`
- Nav: **INFRASTRUCTURE → Disaster Recovery** (sidebar, dock, or spotlight)

## What you can do

1. Open `/dr` and wait for live data from the Atlas gateway (default **:5110**).
