...
Kubernetes StorageClass / CSI integration status for Atlas.
...
- Route: `/kubernetes`
- Nav: **INFRASTRUCTURE → Kubernetes** (sidebar, dock, or spotlight)

## What you can do

1. Open `/kubernetes` and wait for live data from the Atlas gateway (default **:5110**).
