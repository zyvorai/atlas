...
Maintenance windows and safe ops against storage backends.
...
- Route: `/maintenance`
- Nav: **INFRASTRUCTURE → Maintenance** (sidebar, dock, or spotlight)

## What you can do

1. Open `/maintenance` and wait for live data from the Atlas gateway (default **:5110**).
