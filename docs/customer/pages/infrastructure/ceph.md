...
Ceph-specific day-2 operations (OSD, pool, RGW health).
...
- Route: `/ceph`
- Nav: **INFRASTRUCTURE → Ceph** (sidebar, dock, or spotlight)

## What you can do

1. Open `/ceph` and wait for live data from the Atlas gateway (default **:5110**).
