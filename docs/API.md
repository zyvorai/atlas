...
port or auth mechanism. Any MCP host (e.g. [Hermes Agent](HERMES_AGENT.md), Claude) can
connect and call:
...
See `docs/HERMES_AGENT.md` for a concrete client setup walkthrough (token minting +
`~/.hermes/config.yaml`).
