...
- **Atlas Commercial License (ACL)** — for organizations that need more flexibility than AGPL allows.

This document summarizes ACL options. Binding commercial terms are provided by Zyvor sales when you purchase.

## Why ACL

For organizations that require more flexibility, Zyvor offers an Atlas Commercial License (ACL) that provides:

- **Freedom from AGPL obligations** — Deploy and modify Atlas without source code disclosure requirements
...
- Need to embed Atlas in a commercial product without AGPL obligations
- Require enterprise-grade support, SLAs, and legal protections
- Plan to modify Atlas without sharing your changes publicly

## Get a Commercial License

For more information about commercial licensing options, contact:
