...
CREATE TABLE IF NOT EXISTS storage_jobs (
    ...
    request          TEXT NOT NULL DEFAULT '{}' CHECK (json_valid(request)),
...
CREATE TABLE IF NOT EXISTS storage_policies (
    ...
    backend_selector TEXT NOT NULL DEFAULT '{}' CHECK (json_valid(backend_selector)),
    placement        TEXT NOT NULL DEFAULT '{}' CHECK (json_valid(placement)),
    protection       TEXT NOT NULL DEFAULT '{}' CHECK (json_valid(protection)),
    backup           TEXT NOT NULL DEFAULT '{}' CHECK (json_valid(backup)),
    performance      TEXT NOT NULL DEFAULT '{}' CHECK (json_valid(performance)),
